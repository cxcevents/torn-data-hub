      ...
      <CardContent className="p-6">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="font-bold text-sm mb-1">Enter your Torn API key</h2>
            <p className="text-xs text-muted-foreground mb-4">
              Required to scan faction members. Your key is stored locally in your browser and never sent anywhere except directly to the Torn API.
            </p>
            <div className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full bg-muted/40 border border-border/60 rounded-md px-3 py-2 text-sm font-mono pr-9 focus:outline-none focus:ring-1 focus:ring-primary/30 focus:border-primary/50 transition-colors"
                />
                <button
            ...
            <p className="text-[10px] text-muted-foreground/50 mt-2">
              ...
              {" "}— use a limited-access key for safety.
            </p>
          </div>
        </div>
      </CardContent>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-baseline gap-1.5">
                            ...
                            <span className="text-[10px] text-muted-foreground/50 font-mono flex-shrink-0">[{faction.factionId}]</span>
                          </div>
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="w-7 h-7 flex items-center justify-center rounded border border-transparent text-muted-foreground/40 hover:text-primary hover:border-primary/30 hover:bg-primary/10 transition-colors disabled:opacity-30"
                          >
