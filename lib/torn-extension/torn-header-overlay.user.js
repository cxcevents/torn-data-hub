...
(function () {
  ...
  function renderCards() {
    ...
    const cdPct =
      XANAX_CD_MAX > 0
        ? Math.min(100, ((XANAX_CD_MAX - cdLeft) / XANAX_CD_MAX) * 100)
        : 0;
    ...
    const cdLabel = !hasCd
      ? '<span class="tdh-xan-cd" style="color:#444">No drug taken</span>'
      : cdReady
        ? '<span class="tdh-xan-cd ready">Ready</span>'
